...
<head>
  ...
  <title id="title"> Martin Luther King Jr.</title>
</head>

<body>
  <div id="main">
    <h1 class="text_border"> Martin Luther King Jr. Tribute Page </h1>
    <figure id="img-div" class="img_cap"> <img id="image" src="https://www.biography.com/.image/ar_1:1%2Cc_fill%2Ccs_srgb%2Cg_face%2Cq_auto:good%2Cw_300/MTE5NTU2MzE2MjgwNDg5NDgz/martin-luther-king-jr-9365086-2-402.jpg" alt="MLK Jr. Image">
      <figcaption id="img-caption" class="img_cap"> Portrait of Martin Luther King Jr. </figcaption>
    </figure>
    <!-- Copied from Wikipedia -->
    <p id="tribute-info" class="text_border">Martin Luther King Jr. (born Michael King Jr.; January 15, 1929 – April 4, 1968) was an American Baptist minister and activist who became the most visible spokesman and leader in the civil rights movement from 1955 until his assassination in 1968. An African American church leader and the son of early civil rights activist and minister Martin Luther King Sr., King advanced civil rights for people of color in the United States through nonviolence and civil disobedience. Inspired by his Christian beliefs and the nonviolent activism of Mahatma Gandhi, his role in leading protests for civil rights in the South differed in style from the previous accommodationist stances represented by Booker T. Washington and black-and-tan faction leader Perry Wilbon Howard II.
